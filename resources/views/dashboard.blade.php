    ...
    <main class="container-fluid pt-5">
        ...
        <div class="row pt-3">
            <div class="col-md-12 mt-3">
                <div class="card pt-4 pb-2 mx-5 px-3 rounded-4"
                    style="background-color: #0c134f; box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.1);">
                    <div class="card-body text-light">
                        <h4 class="card-title fw-semibold fst-italic">Kategori Pilihan :</h4>
                        <div class="d-flex pt-3">
                            <img class="border border-dark border-5 rounded-4 mx-1" width="90"
